...
INSERT INTO "new_Match" ("createdAt", "dropOffCompleted", "id", "notificationSent", "pickUpCompleted", "senderId", "senderListingId", "status", "travelerId", "travelerListingId", "updatedAt") SELECT "createdAt", "dropOffCompleted", "id", "notificationSent", "pickUpCompleted", "senderId", "senderListingId", "status", "travelerId", "travelerListingId", "updatedAt" FROM "Match";
DROP TABLE "Match";
